  ...
  "cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        accent: "bg-accent text-accent-foreground dark:hover:bg-accent/50",
        /**
         * The console switch: transparent ground, hairline border, accent
         * text. Hover moves the border and nothing else — no fill, no growth —
         * which is what keeps a dense surface calm.
         */
        console:
          "motion-control border border-[var(--border-2)] bg-transparent text-[var(--accent-3)] hover:border-[var(--accent-2)]",
        "console-primary":
          "motion-control border border-[var(--accent-2)] bg-[color-mix(in_srgb,var(--accent-1)_18%,transparent)] text-[var(--text)] hover:bg-[color-mix(in_srgb,var(--accent-1)_28%,transparent)]",
